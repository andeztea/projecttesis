...
class KelasModel extends CI_Model
{
    ...
    protected $query;
    protected $column_order = array(null, 'kode_kelas', 'nama_kelas', 'mata_kuliah', 'sks'); //set column field database for datatable orderable
    protected $column_search = array('kode_kelas', 'nama_kelas', 'mata_kuliah', 'sks'); //set column field database for datatable searchable 
    ...
    public function get_entries($where = false,$id_pt = false)
    {
     ...
     public function get_entries2($where = false)
    {
    ...
    {
        $this->db->from('tb_kelas')->where('tampilkan', 'ya');
