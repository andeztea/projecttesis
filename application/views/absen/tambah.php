<form action="<?= site_url('AbsenController/store') ?>" method="post" id="form_store_absen">
	<div class="modal-header elevation-1 d-flex justify-content-center py-2">
		<h4><strong>Tambah Nilai Kehadiran</strong></h4>
	</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<input type="text" step="any" class="form-control" name="skor_nilai">
