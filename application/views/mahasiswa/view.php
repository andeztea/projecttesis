...
<div class="modal-body elevation-1">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
            <strong for="nama_kelas">Kelas</strong>
            <select name="nama_kelas" id="nama_kelas" class="form-control select2bs4">
                <option value="">-- Pilihan --</option>
                <?php foreach ($kelass as $kelas) { ?>
                    <option <?= $kelas->id == $mahasiswa->id_kelas ? 'selected' : '' ?> value="<?= $kelas->id ?>"><?= $kelas->nama_kelas ?></option>
                <?php } ?>
            </select>
            <small class="text-danger nama_kelas_error"></small>
            </div>
        </div>
    </div>
