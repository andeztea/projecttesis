<form action="<?= site_url('NilaiController/update/' . $nilai->id) ?>" method="post" id="form_store_nilai">
    <div class="modal-header elevation-1 d-flex justify-content-center py-2">
        <h4><strong>Edit Bobot Nilai</strong></h4>
    </div>
        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2bs4" name="id_akd">
                        ...
                        <?php foreach ($akademiks as $akademik) { ?>
                            <option <?= $akademik->id == $nilai->id_akd ? 'selected' : '' ?> value="<?= $akademik->id ?>"><?= $akademik->thn_akademik ?> / <?= $akademik->periode ?></option>
                        <?php } ?>
                    </select>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="nilai_min" value="<?= $nilai->nilai_min ?>">
                    <small class="text-danger error-text nilai_min"></small>
                </div>

                <div class="form-group">
                    <label class="text-muted m-0">Nilai Huruf</label>
                    <input type="text" class="form-control" name="nilai_huruf" value="<?= $nilai->nilai_huruf ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="nilai_max" value="<?= $nilai->nilai_max ?>">
                    <small class="text-danger error-text nilai_max"></small>
                </div>

                <div class="form-group">
                    <label class="text-muted m-0">Keterangan</label>
                    <select class="form-control select2bs4" name="keterangan" value="<?= $nilai->keterangan ?>">
                        <option value="">--Pilih--</option>
                        <option <?= $nilai->keterangan == 'Lulus' ? 'selected' : '' ?> value="1">Lulus</option>
                        <option <?= $nilai->keterangan == 'Tidak Lulus' ? 'selected' : '' ?> value="2">Tidak Lulus</option>
                    </select>
