			...
			<div class="row">
				<div class="col-md-12">
					<div class="card card-outline card-primary">
						...
						<div class="card-body">
							<table id="tableKelasDosen" class="table-bordered table-hover table">
								<thead>
									<tr>
										<th>No</th>
										<th>Nama Kelas</th>
										<th>Tahun Akademik</td>
										<th>Aksi</th>
									</tr>
								</thead>
							</table>
	...
	$(document).ready(function() {
		...
		<?php if ($_SESSION['id_role'] == 'Dosen') { ?>
			$('#buttons').html("<div class='text-center'>" +
				" <a href='<?= site_url('PengajarController/tambah') ?>' class='btn btn-sm btn-info'>Tambah</a>" +
				"</div>");
		<?php } ?>

		swal_delete('#hapus_pengajar', '#tableKelasDosen')
	});
</script>
</body>
