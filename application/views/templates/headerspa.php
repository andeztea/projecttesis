    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-2">
            <div class="elevation-1 mt-1 p-2">
                <img class="image" style="width: 100%; height:100px" src="<?= base_url('assets') ?>/dist/img/kemdikbud.jpg">
            </div>
            ...
            <div class="sidebar mt-3">
                <div class="user-panel d-flex pb-3">
                    ...
                    <div class="info">
                        <a href="<?= site_url('ProfileController/index/' . $_SESSION['id_user']) ?>" class="d-block"><?= $_SESSION['username'] ?></a></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('AuthController/logout') ?>" class="nav-link" id="logout"><i class="nav-icon fa fa-power-off" aria-hidden="true"></i><p>Logout</p></a>
                        </li> 
                    </ul>
                </nav>
            </div>
